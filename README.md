...
15. [folke/flash.nvim](https://github.com/folke/flash.nvim) navigate with search labels, enhanced character motions, and Treesitter integration.
    your code
16. [nvim-tree/nvim-tree.lua](https://github.com/nvim-tree/nvim-tree.lua) File
    tree
...
23. [akinsho/bufferline.nvim](https://github.com/akinsho/bufferline.nvim) Buffers
    in tabs
24. [delphinus/vim-firestore](https://github.com/delphinus/vim-firestore) Syntax
    highlighting and completion for Firebase rules
25. [rmagatti/auto-session](https://github.com/rmagatti/auto-session) Session
    management
26. [goolord/alpha-nvim](https://github.com/goolord/alpha-nvim) Dashboard
27. [mbbill/undotree](https://github.com/mbbill/undotree) Undotree
